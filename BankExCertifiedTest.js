...
contract('BankExCertified', function(accounts) {
    ...
    it("Should throw on certify", function() {
        ...
        return BankExCertified.deployed().then(function(instance) {
            ...
            return bankExCertified.certify("0xFF7766715a9Ea89007a2Fc6d2c2D7b6909490E25", {from : web3.eth.accounts[1]});
    ...
    it("Should throw on unCertify", function() {
        ...
        return BankExCertified.deployed().then(function(instance) {
            ...
            return bankExCertified.unCertify("0xFF7766715a9Ea89007a2Fc6d2c2D7b6909490E25", {from : web3.eth.accounts[1]});
